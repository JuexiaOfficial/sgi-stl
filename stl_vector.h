...
public:
  // vector 的嵌套类型定义
  typedef _Tp value_type;                    // vector的元素类型
  typedef value_type *pointer;               // vector的指针类型
  typedef const value_type *const_pointer;   // vector的常量指针类型
  typedef value_type *iterator;              // vector的迭代器是普通指针
  typedef const value_type *const_iterator;  // vector的常量迭代器类型
  typedef value_type &reference;             // vector的引用类型
  typedef const value_type &const_reference; // vector的常量引用类型
  typedef size_t size_type;                  // vector的大小类型
  typedef ptrdiff_t difference_type;         // vector的差值类型
